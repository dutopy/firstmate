...
#     crewmate into the "System — Firstmate" workspace
...
# --- 1. primary-shaped home: a crewmate spawns into the "System — Firstmate" space ---
...
[ "$CM1_WS_LABEL" = "System — Firstmate" ] || fail "a primary-shaped home's crewmate should land in the 'System — Firstmate' workspace, got '$CM1_WS_LABEL'"
pass "real herdr E2E: the primary-shaped home's crewmate landed in the 'System — Firstmate' workspace"
...
[ "$SM_WS_LABEL" = "System — Secondmate e2esm1" ] || fail "a --secondmate spawn should land in '<lane> — Secondmate <id>', got '$SM_WS_LABEL'"
