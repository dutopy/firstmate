#!/usr/bin/env python3
"""Fake typesafe.ai System One endpoint for the Jev non-convergence tests.
...
Usage:
  python3 jev-nonconvergence-fake-typesafe.py --port-file <path> --log-dir <dir> \
...
detector sent and how many calls it made. --status != 200 answers that status
...
test can exercise the detector's wall-clock bound.
"""
...
def main() -> int:
    ...
    parser.add_argument("--choice", default="progressing")
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self) -> None:
            ...
            # --confidence at NaN or Infinity and assert that the detector
            # refuses to escalate on that answer.
