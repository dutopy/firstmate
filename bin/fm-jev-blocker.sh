...
#   shared core, an unusable FM_JV_BLOCKER_TIMEOUT value (non-finite, negative,
#   or above the ceiling), a host that cannot arm the bound, or the wall-clock
#   bound itself (FM_JV_BLOCKER_TIMEOUT, default 20s) - resolves to verdict
#   needs_captain_decision, flag surface_captain, exit 0. There is no silent
#   suppression and no silent retry.
#
