...
The ten hints added on 2026-09-17 for newly added serial scripts (`fm-discord-live`, `fm-discord-workspace-concurrency`, `fm-discord-workspace`, `fm-inbox-external`, `fm-jev-blocker`, `fm-jev-finding`, `fm-jev-guard`, `fm-jev-lane`, `fm-procevent-discord-workspace`, and `fm-watch-inbox-surface`) are single local `FM_TEST_END duration_ms=` measurements, not CI maxima, because they were recorded to keep the lane hinted when those scripts landed together and no green CI run covered them yet.
