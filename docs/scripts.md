...
| `fm-discord-conversation-console.sh` | Talk to Firstmate from Discord: capture #firstmate captain messages, transcribe captain voice messages through Groq Whisper, and answer in the same conversation thread ([discord-conversation-console.md](discord-conversation-console.md)) |
